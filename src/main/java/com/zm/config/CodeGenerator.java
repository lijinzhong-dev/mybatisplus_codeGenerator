...
//        gc.setSwagger2(true); 实体属性 Swagger2 注解
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/leyou?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
        ...
        pc.setParent("com.zm");//设置生成文件的包的根路径
...
//        strategy.setTablePrefix(pc.getModuleName() + "_");
        strategy.setTablePrefix("tb_");//去掉数据库表前缀"tb_"
